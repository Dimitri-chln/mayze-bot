import {Client, VoiceChannel, Message, Snowflake, StreamDispatcher, VoiceConnection, VoiceState} from "discord.js";
...
class Util {
    ...
    getVideoBySearch(search: String, options: Object<DefaultSearchOption>, queue: Queue, requestedBy: String): Promise<Song>;
