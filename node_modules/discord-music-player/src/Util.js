// Self Definitions
const Playlist = require('discord-music-player/src/Playlist');
const Song = require('discord-music-player/src/Song');
const Queue = require('discord-music-player/src/Queue');
