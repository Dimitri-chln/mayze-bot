...
var command = {
    ...
    run: function (interaction, translations) { return __awaiter(void 0, void 0, void 0, function () {
        var pages, _a, _b, _c, name_1, palette, page;
        var e_1, _d;
        return __generator(this, function (_e) {
            pages = [];
            try {
                for (_a = __values(Util_1.default.palettes), _b = _a.next(); !_b.done; _b = _a.next()) {
                    _c = __read(_b.value, 2), name_1 = _c[0], palette = _c[1];
                    page = {
                        embeds: [
                            {
                                author: {
