...
var command = {
    ...
    run: function (interaction, translations) { return __awaiter(void 0, void 0, void 0, function () {
        var subCommand, snipedMessage, snipedMessage, snipedReaction;
            ...
            switch (subCommand) {
                case "message": {
                    ...
                    interaction.reply({
                        ...
                        attachments: Array.from(snipedMessage.attachments).map(function (attachment) { return attachment[1]; })
                    });
                    break;
                }
                case "edit": {
                        ...
                        embeds: [
                            {
                                ...
                                fields: [
                                    {
                                        name: "\u200b",
                                        value: translations.data.description(snipedReaction.user.tag, snipedReaction.reaction.message.url, snipedReaction.reaction.emoji.toString())
                                    }
                                ],
                                footer: {
                                    text: "✨ Mayze ✨",
