...
var command = {
    ...
    run: function (interaction, translations) { return __awaiter(void 0, void 0, void 0, function () {
        var member, jailedRole, unJailedRoles, jailedRoles, jailedRoles, unJailedRoles;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!!member.roles.cache.has(jailedRole.id)) return [3 /*break*/, 3];
                    unJailedRoles = member.roles.cache.filter(function (role) { return interaction.guild.roles.cache.some(function (r) { return r.name === role.name + " (Jailed)"; }); });
                    jailedRoles = interaction.guild.roles.cache.filter(function (role) { return member.roles.cache.some(function (r) { return role.name === r.name + " (Jailed)"; }); });
                    jailedRoles.set(jailedRole.id, jailedRole);
                    return [4 /*yield*/, member.roles.remove(unJailedRoles).catch(console.error)];
                case 1:
                    _a.sent();
