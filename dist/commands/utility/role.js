                ...
                embeds: [
                    {
                        ...
                        description: translations.data.description(role.id, role.color.toString(), role.hexColor, role.position.toString(), roleMembers.length.toString(), (_a = roleMembers.join(", ")) !== null && _a !== void 0 ? _a : " "),
                        footer: {
                            text: "✨ Mayze ✨"
                        }
                    }
