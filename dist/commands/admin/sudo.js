...
var command = {
    ...
    run: function (interaction, translations) { return __awaiter(void 0, void 0, void 0, function () {
        var user, message, webhook;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    user = interaction.options.getUser("user");
                    message = interaction.options.getString("message");
                    return [4 /*yield*/, interaction.client.fetchWebhook("800803785949577266")];
                case 1:
                    webhook = _a.sent();
                    if (!(webhook.channelId !== interaction.channel.id)) return [3 /*break*/, 3];
                    return [4 /*yield*/, webhook.edit({ channel: interaction.channel.id })];
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3:
