...
const command = {
	...
	*/
	execute: async (message, args, options, language, languageCode) => {
		...
		msg.edit(language.get(language.updated, members.size - errors === 0, members.size - errors === 1, members.size - errors > 1, members.size - errors, errors, errors > 1)).catch(console.error);
	}
};
